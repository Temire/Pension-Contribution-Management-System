...
//@Tab(filter=RoleFilter.class, baseCondition="${name} IN ?") 
public class Role implements java.io.Serializable {
	...
	@RemoveAction("Collection.removeSelected")
	...
	public static Role findRole(String roleName){
		Role role = null;
		try {
			role = (Role) XPersistence.getManager().
					createQuery("FROM Role r WHERE r.name='" + roleName + "'").getSingleResult();
		} catch (Exception e) {
