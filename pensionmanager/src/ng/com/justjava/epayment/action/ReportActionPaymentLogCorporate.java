...
import ng.com.justjava.epayment.model.ReportControllerPaymentLogCorporate.Format;
import ng.com.justjava.epayment.model.ReportControllerPaymentLogCorporate.Report;
...
public class ReportActionPaymentLogCorporate extends JasperReportBaseAction implements IChangeControllersAction{
	...
	System.out.println("Entering execute method");
		 ...
		 if (Is.empty(report)||Is.empty(format)) {
		 ...
		 Long pfaId = 0L;
			...
			//pfaId = (pfaId==null?0:pfaId);
			
		System.out.println("The pfaid is "+pfaId);
		System.out.println("The report selected is "+report);
		
		Corporate corporate = UserManager.getCorporateOfLoginUser(); 
		System.out.println("The corporate is "+corporate.getId());
		
		System.out.println("The report selected is "+report);
		
				//reportName ="paymentlog_corporate.jrxml";
		reportName ="report_temp_corporate.jrxml";
				System.out.println("about to enter datasource");		
				
					dataSource = PaymentLog.getPaymentLogCorporate(corporate.getId(),pfaId,fromDate,toDate);
