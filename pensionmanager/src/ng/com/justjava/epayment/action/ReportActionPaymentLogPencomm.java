...
import ng.com.justjava.epayment.model.ReportControllerPaymentLogPencomm.Format;
import ng.com.justjava.epayment.model.ReportControllerPaymentLogPencomm.Report;
...
public class ReportActionPaymentLogPencomm extends JasperReportBaseAction implements IChangeControllersAction{
	...
	System.out.println("Entering execute method");
		...
		Long pfcId = 0L;
			if( custodianKeyValue != null)
				pfcId = (Long)custodianKeyValue.get("id");
			
			corporateId = (corporateId==null?0:corporateId);
			//pfcId = (pfcId==null?0:pfcId);
		...
		System.out.println("The corporate selected is "+corporateId);
				...
				reportName ="report_temp.jrxml";
				System.out.println("about to enter datasource");		
				
					dataSource = PaymentLog.getPaymentLogPencomm(pfcId,corporateId,pfaId,fromDate,toDate);
